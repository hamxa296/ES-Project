...
plt.legend(airbag_survivors_counts.index, title='Airbag Deployment', loc='best')
plt.show()
...
plt.legend(airbag_deceased_counts.index, title='Airbag Deployment', loc='best')
plt.show()
...
plt.legend(seatbelt_survival_counts.index, title='Seatbelt Use', loc='best')
plt.show()
