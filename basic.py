...
plt.pie(airbag_survivors_counts, startangle=90, colors=['#4CAF50', '#81C784'], autopct='%1.1f%%', textprops={'fontsize': 16})
plt.title('Airbag Deployment Among Survivors')
plt.legend(airbag_survivors_counts.index, title='Seatbelt Use', loc='upper left', fontsize=12, title_fontsize=14, bbox_to_anchor=(0.8, 1))
plt.show()

airbag_deceased_counts = df[df['dead'] == 'DEAD']['airbag'].value_counts()
plt.figure(figsize=(8, 6))
plt.pie(airbag_deceased_counts, startangle=90, colors=['#E53935', '#FF8A65'], autopct='%1.1f%%', textprops={'fontsize': 16})
plt.title('Airbag Deployment Among Deceased')
plt.legend(airbag_deceased_counts.index, title='Seatbelt Use', loc='upper left', fontsize=12, title_fontsize=14, bbox_to_anchor=(0.8, 1))
plt.show()

seatbelt_survival_counts = df[df['dead'] == 'ALIVE']['seatbelt'].value_counts()
plt.figure(figsize=(8, 6))
plt.pie(seatbelt_survival_counts, startangle=90, colors=['#1E88E5', '#90CAF9'], autopct='%1.1f%%', textprops={'fontsize': 16})
plt.title('Seatbelt Use Among Survivors')
plt.legend(seatbelt_survival_counts.index, title='Seatbelt Use', loc='upper left', fontsize=12, title_fontsize=14, bbox_to_anchor=(0.8, 1))
plt.show()

seatbelt_deceased_counts = df[df['dead'] == 'DEAD']['seatbelt'].value_counts()
plt.figure(figsize=(8, 6))
plt.pie(seatbelt_deceased_counts, startangle=90, colors=['#FB8C00', '#FFD54F'], autopct='%1.1f%%', textprops={'fontsize': 16})
plt.title('Seatbelt Use Among Deceased')
plt.legend(seatbelt_deceased_counts.index, title='Seatbelt Use', loc='upper left', fontsize=12, title_fontsize=14, bbox_to_anchor=(0.8, 1))
plt.show()
...
mosaic(table.stack(), title='Mosaic Plot: Frontal Collision, Sex, and Death')
plt.show()